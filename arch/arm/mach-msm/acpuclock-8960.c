...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[7]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1100000, 4 },
	[8]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1100000, 4 },
	[9]  = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1100000, 4 },
	[10] = { {  918000, HFPLL, 1, 0x22 }, 1150000, 1100000, 6 },
	[11] = { {  972000, HFPLL, 1, 0x24 }, 1150000, 1100000, 6 },
	[12] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1100000, 6 },
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(12), 1175000, AVS(0x400015) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(12), 1200000, AVS(0x400015) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1225000, AVS(0x400015) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1237500, AVS(0x400015) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(18), 1250000, AVS(0x400015) },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(20), 1262500, AVS(0x400015) },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	{ 1, {   162000, HFPLL, 1, 0x06 }, L2(0),   850000, AVS(0x40007F) },
	{ 1, {   270000, HFPLL, 1, 0x0A }, L2(0),   875000, AVS(0x40007F) },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   900000, AVS(0x40007F) },
	{ 1, {   486000, HFPLL, 1, 0x12 }, L2(6),   925000 },
	...
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(12), 1125000, AVS(0x400015) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(12), 1150000, AVS(0x400015) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1175000, AVS(0x400015) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1187500, AVS(0x400015) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(18), 1200000, AVS(0x400015) },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(20), 1212500, AVS(0x400015) },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	{ 1, {   162000, HFPLL, 1, 0x06 }, L2(0),   800000, AVS(0x4000FF) },
	{ 1, {   270000, HFPLL, 1, 0x0A }, L2(0),   825000, AVS(0x4000FF) },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   850000, AVS(0x4000FF) },
	{ 1, {   486000, HFPLL, 1, 0x12 }, L2(6),   875000 },
	...
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(12), 1075000, AVS(0x10001B) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(12), 1100000, AVS(0x10001B) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1125000, AVS(0x400012) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1137500, AVS(0x400012) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(18), 1150000, AVS(0x400012) },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(20), 1162500, AVS(0x400012) },
	{ 0, { 0 } }
};
